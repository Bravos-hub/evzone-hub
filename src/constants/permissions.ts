...
export const PERMISSIONS: Record<string, FeaturePermissions> = {
  ...
  team: {
    access: [...ROLE_GROUPS.PLATFORM_OPS, 'STATION_ADMIN', 'STATION_OPERATOR', 'STATION_OWNER'],
    viewAll: [...ROLE_GROUPS.PLATFORM_OPS, 'STATION_ADMIN', 'STATION_OPERATOR', 'STATION_OWNER'],
    invite: [...ROLE_GROUPS.PLATFORM_OPS, 'STATION_ADMIN', 'STATION_OPERATOR', 'STATION_OWNER'],
    remove: [...ROLE_GROUPS.PLATFORM_OPS, 'STATION_ADMIN', 'STATION_OPERATOR', 'STATION_OWNER'],
    changeRole: [...ROLE_GROUPS.PLATFORM_OPS, 'STATION_ADMIN', 'STATION_OPERATOR', 'STATION_OWNER'],
  },
