                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        <span className="px-2 py-0.5 rounded bg-white/5 border border-white/10 text-[9px] font-black uppercase text-text-secondary">Model: {lease.preferredLeaseModel}</span>
                    ...
                    <div className="text-right">
                      <p className="text-sm font-black text-text">${((lease as { earnings?: number }).earnings || 0).toLocaleString()}</p>
