  ...
  switch (role) {
    ...
    case 'STATION_OPERATOR':
      return [
        ...
        { label: 'Charge Points / Connectors', path: '/stations/charge-points' },
        { label: 'Sessions & Transactions', path: '/sessions' },
        { label: 'Pricing / Tariffs', path: '/tariffs' },
        { label: 'Bookings', path: '/stations/bookings' },
        { label: 'Wallet / Revenue', path: '/billing' },
        { label: 'Maintenance & Work Orders', path: '/incidents' },
